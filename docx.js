...
// Одно положение на оба документа: слева, поверх строк подписи — так оно
// нравится Елене в счёте, и так же теперь в акте. Привязка идёт к самой
// строке подписи, поэтому оттиск не зависит от длины таблицы и просмотрщика.
const STAMP_INVOICE = { up: 0.45, left: 1150000 };
const STAMP_ACT = { up: 0.45, left: 1150000 };
